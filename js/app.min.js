( () => {
    ...
    var e = function(e) {
        ...
        e.style.height = s ? "".concat(s, "px") : "0px",
      ...
      , i = function() {
        ...
        if (s) {
            var i = document.querySelectorAll("[data-lp]");
            setTimeout((function() {
      ...
      , n = function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 500
          , t = document.querySelector("body");
        if (s) {
            for (var i = document.querySelectorAll("[data-lp]"), n = 0; n < i.length; n++) {
                var r = i[n];
                r.style.paddingRight = window.innerWidth - document.querySelector(".wrapper").offsetWidth + "px"
            }
    ...
    function r(e, t) {
        var s = Array.from(e).filter((function(e, s, i) {
            if (e.dataset[t])
        ...
        return function(...t) {
            if (void 0 === t[0]) {
                for (let t = 0; t < this.length; t += 1)
                    v.indexOf(e) < 0 && (e in this[t] ? this[t][e]() : m(this[t]).trigger(e));
                return this
            }
            return this.on(e, ...t)
        }
        ...
        for (let s = 1; s < arguments.length; s += 1) {
            ...
            if (null != i && !x(i)) {
                ...
                for (let t = 0, n = s.length; t < n; t += 1) {
                    ...
                    void 0 !== r && r.enumerable && (E(e[n]) && E(i[n]) ? i[n].__swiper__ ? e[n] = i[n] : C(e[n], i[n]) : !E(e[n]) && E(i[n]) ? (e[n] = {},
                    i[n].__swiper__ ? e[n] = i[n] : C(e[n], i[n])) : e[n] = i[n])
                }
            }
        }
        return e
    ...
    function $(e) {
        ...
        P || (P = function(e) {
            ...
            const u = r.match(/(iPod)(.*OS\s([\d_]+))?/)
              ...
              , f = "Win32" === n;
            let m = "MacIntel" === n;
            return !c && m && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${o}x${l}`) >= 0 && (c = r.match(/(Version)\/([\d.]+)/),
            c || (c = [0, 1, "13_0_0"]),
            m = !1),
            d && !f && (a.os = "android",
            a.android = !0),
    ...
    const z = {
        ...
        updateSlides: function() {
            ...
            i.centeredSlides && i.cssMode && (k(e.wrapperEl, "--swiper-centered-offset-before", ""),
            ...
            for (let n = 0; n < p; n += 1) {
                ...
                "none" !== a.css("display")) {
                    ...
                    f.push(x),
                    i.centeredSlides ? (y = y + x / 2 + S / 2 + b,
                    0 === S && 0 !== n && (y = y - r / 2 - b),
                    0 === n && (y = y - r / 2 - b),
                    Math.abs(y) < .001 && (y = 0),
            ...
            a && o && ("slide" === i.effect || "coverflow" === i.effect) && n.css({
            ...
            i.centeredSlides && i.cssMode && !i.centeredSlidesBounds) {
                ...
                k(e.wrapperEl, "--swiper-centered-offset-after", e.size / 2 - f[f.length - 1] / 2 + "px");
        ...
        updateSlidesClasses: function() {
            ...
            s.loop && (o.hasClass(s.slideDuplicateClass) ? i.children(`.${s.slideClass}:not(.${s.slideDuplicateClass})[data-swiper-slide-index="${r}"]`).addClass(s.slideDuplicateActiveClass) : i.children(`.${s.slideClass}.${s.slideDuplicateClass}[data-swiper-slide-index="${r}"]`).addClass(s.slideDuplicateActiveClass));
    ...
    function G(e) {
        ...
        let o = i;
        if (o || (o = r > a ? "next" : r < a ? "prev" : "reset"),
        t.emit(`transition${n}`),
        s && r !== a) {
            if ("reset" === o)
        ...
        slideTo: function(e, t, s, i, n) {
            ...
            if (r.initialized && a !== p) {
                if (!r.allowSlideNext && g < r.translate && g < r.minTranslate())
                    return !1;
                if (!r.allowSlidePrev && g > r.translate && g > r.maxTranslate() && (p || 0) !== a)
                    return !1
            }
            let w;
    ...
    function H(e) {
        ...
        if (n.isTouched && n.isMoved)
            return;
        !!r.noSwipingClass && "" !== r.noSwipingClass && l.target && l.target.shadowRoot && e.path && e.path[0] && (c = b(e.path[0]));
        const u = r.noSwipingSelector ? r.noSwipingSelector : `.${r.noSwipingClass}`
          , h = !(!l.target || !l.target.shadowRoot);
        if (r.noSwiping && (h ? function(e, t) {
            return void 0 === t && (t = this),
            function t(s) {
                return s && s !== d() && s !== p() ? (s.assignedSlot && (s = s.assignedSlot),
                s.closest(e) || t(s.getRootNode().host)) : null
            }(t)
        }(u, l.target) : c.closest(u)[0]))
        ...
        "touchstart" !== l.type) {
            ...
            s.activeElement && b(s.activeElement).is(n.focusableElements) && s.activeElement !== c[0] && s.activeElement.blur();
    ...
    function q(e) {
        ...
        if (l.preventedByNestedSwiper)
            ...
            void (r.startY = u);
        if (!s.allowTouchMove)
            return b(l.target).is(i.focusableElements) || (s.allowClick = !1),
        ...
        if (i.isTouchEvent && n.touchReleaseOnEdges && !n.loop)
            if (s.isVertical()) {
                ...
                return;
        if (i.isTouchEvent && t.activeElement && l.target === t.activeElement && b(l.target).is(i.focusableElements))
            return i.isMoved = !0,
            void (s.allowClick = !1);
        ...
        n.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + m) ** g)) : m < 0 && i.currentTranslate < s.maxTranslate() && (v = !1,
        n.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - m) ** g)),
    ...
    function j(e) {
        ...
        if (c > i.longSwipesMs) {
            ...
            "next" === t.swipeDirection && (v >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? f : u + g) : t.slideTo(u)),
            "prev" === t.swipeDirection && (v > 1 - i.longSwipesRatio ? t.slideTo(u + g) : null !== m && v < 0 && Math.abs(v) > i.longSwipesRatio ? t.slideTo(m) : t.slideTo(u))
        } else {
            if (!i.shortSwipes)
                return void t.slideTo(t.activeIndex);
            t.navigation && (l.target === t.navigation.nextEl || l.target === t.navigation.prevEl) ? l.target === t.navigation.nextEl ? t.slideTo(u + g) : t.slideTo(u) : ("next" === t.swipeDirection && t.slideTo(null !== f ? f : u + g),
    ...
    const X = (e, t) => {
        ...
        if (l.touch) {
            ...
            r[p](n.move, e.onTouchMove, l.passiveListener ? {
                passive: !1,
                capture: c
            } : c),
        ...
        i.updateOnWindowResize ? e[u](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", V, !0) : e[u]("observerUpdate", V, !0)
    }
    ;
    const U = {
        attachEvents: function() {
            ...
            e.onClick = W.bind(e),
            i.touch && !R && (t.addEventListener("touchstart", Y),
            R = !0),
            X(e, "on")
        },
    ...
    const te = {
        ...
        images: {
            loadImage: function(e, t, s, i, n, r) {
                ...
                b(e).parent("picture")[0] || e.complete && n ? l() : t ? (o = new a.Image,
                o.onload = l,
                o.onerror = l,
                i && (o.sizes = i),
                s && (o.srcset = s),
    ...
    ie.use([function(e) {
        ...
        s("init", ( () => {
            ...
            r.observe(t.el)) : (n.addEventListener("resize", o),
    ...
    (le = document.querySelectorAll('[class*="__swiper"]:not(.swiper-wrapper)')) && le.forEach((function(e) {
        e.parentElement.classList.add("swiper"),
        e.classList.add("swiper-wrapper");
        var t, s = ae(e.children);
        try {
            for (s.s(); !(t = s.n()).done; )
    ...
    document.querySelector(".intro__slider") && new ne(".intro__slider",{
        modules: [re],
        observer: !0,
        observeParents: !0,
        slidesPerView: 1,
    ...
    document.querySelector(".gallery__slider") && new ne(".gallery__slider",{
        modules: [re],
        observer: !0,
        observeParents: !0,
        slidesPerView: 1,
    ...
    de.prototype.init = function() {
        ...
        for (var a = function(s) {
            ...
            e.mediaHandler(r, o)
        }, o = 0; o < this.mediaQueries.length; o++)
            a(o)
    }
    ,
    de.prototype.mediaHandler = function(e, t) {
        if (e.matches)
    ...
    ,
    de.prototype.moveTo = function(e, t, s) {
    ...
    ,
    new de("max").init();
    var ce = document.querySelector(".header")
      , pe = document.querySelector(".intro__swiper");
    window.addEventListener("load", (function() {
        pe && (pe.style.minHeight = "calc(100dvh - " + ce.offsetHeight + "px)")
    }
    )),
    ...
    function() {
        ...
        if (e) {
            var t = document.querySelector("nav").querySelectorAll("a");
        ...
        var r = document.querySelector(".header")
          , a = document.querySelector(".header__menu");
        window.addEventListener("load", (function() {
            r && (a.style.top = "calc(" + r.offsetHeight + "px - 1px)")
        }
        )),
        window.addEventListener("resize", (function() {
            r && (a.style.top = "calc(" + r.offsetHeight + "px - 1px)")
    ...
    document.getElementById("year") && (document.getElementById("year").innerHTML = (new Date).getFullYear()),
    function() {
        var e = document.querySelectorAll(".video__item");
        if (e) {
            e.forEach((function(e) {
                var t = e.getAttribute("data-video")
                  , s = "https://youtu.be/".length
                  , i = t.substring(s, t.length)
                  , n = e.querySelector("img")
                  , r = "https://i.ytimg.com/vi/" + i + "/maxresdefault.jpg";
                ...
                e.addEventListener("click", (function(t) {
                    ...
                    var s = function(e) {
                        ...
                        t.setAttribute("src", function(e) {
                            return "https://www.youtube.com/embed/" + e + "?autoplay=1"
                        }(e)),
    ...
    function() {
        var s = document.querySelectorAll("[data-tabs]")
          , i = [];
        if (s.length > 0) {
            var n = function() {
                if (location.hash)
            ...
            n && n.startsWith("tab-") && (i = n.replace("tab-", "").split("-")),
            s.forEach((function(e, t) {
                e.classList.add("_tab-init"),
                e.setAttribute("data-tabs-index", t),
                e.addEventListener("click", d),
                function(e) {
                    var t = e.querySelectorAll("[data-tabs-titles]>*")
                      , s = e.querySelectorAll("[data-tabs-body]>*")
                      , n = e.dataset.tabsIndex
                      , r = i[0] == n;
                    if (r) {
                        var a = e.querySelector("[data-tabs-titles]>._tab-active");
                        a && a.classList.remove("_tab-active")
                    }
                    s.length && (s = Array.from(s).filter((function(t) {
                        return t.closest("[data-tabs]") === e
                    }
                    )),
        ...
        function o(e, t) {
            e.forEach((function(e) {
                var s = (e = e.item).querySelector("[data-tabs-titles]")
                ...
                (r = Array.from(r).filter((function(t) {
                    ...
                    t.matches ? (n.append(i[a]),
                    n.append(r),
                    e.classList.add("_tab-spoller")) : (s.append(i[a]),
        ...
        function l(s) {
            var i = s.querySelectorAll("[data-tabs-title]")
            ...
            if (n.length > 0) {
                var o = s.hasAttribute("data-tabs-hash");
                n = Array.from(n).filter((function(e) {
                    return e.closest("[data-tabs]") === s
                }
                )),
                ...
                n.forEach((function(s, n) {
                    i[n].classList.contains("_tab-active") ? (a ? t(s, a) : s.hidden = !1,
                    o && !s.closest(".popup") && function(e) {
                        e = e ? "#".concat(e) : window.location.href.split("#")[0],
                        history.pushState("", "", e)
                    }("tab-".concat(r, "-").concat(n))) : a ? e(s, a) : s.hidden = !0
                }
                ))
            }
        }
        function d(e) {
            ...
            if (t.closest("[data-tabs-title]")) {
                var s = t.closest("[data-tabs-title]")
                  , i = s.closest("[data-tabs]");
                if (!s.classList.contains("_tab-active") && !i.querySelector("._slide")) {
                    var n = i.querySelectorAll("[data-tabs-title]._tab-active");
                    n.length && (n = Array.from(n).filter((function(e) {
                        return e.closest("[data-tabs]") === i
                    }
                    ))),
                    n.length && n[0].classList.remove("_tab-active"),
